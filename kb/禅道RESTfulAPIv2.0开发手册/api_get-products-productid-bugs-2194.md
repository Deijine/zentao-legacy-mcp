...
GET  /products/:productID/bugs 

##  获取产品Bug列表 

###  请求URL 
https://xxx.com/api.php/v2/products/:productID/bugs
...
###  请求参数 
|   名称   必填   描述 
|   browseType   否   状态，默认是unclosed。(all 全部 | unclosed 未关闭 | assigntome 指派给我 | openedbyme 我创建 | assignedbyme 由我指派) 
