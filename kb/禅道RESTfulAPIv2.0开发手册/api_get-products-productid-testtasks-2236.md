...
GET/products/:productID/testtasks

##  获取产品测试单列表 

### 请求URL
https://xxx.com/api.php/v2/products/:productID/testtasks
    ...
    "testtasks": [
        {
            ...
            "multiple": "1",
            "productName": "智能照明",
            "executionName": "智能设备研发\/智能设备研发3.2版本开发",
            "buildName": "版本v1.0",
            "branch": "",
            "projectName": "智能设备研发",
            "executionBuild": "版本v1.0\/智能设备研发3.2版本开发",
            "rawStatus": "wait"
        }
    ]
}
