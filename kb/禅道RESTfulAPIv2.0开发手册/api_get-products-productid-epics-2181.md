...
GET/products/:productID/epics

##  获取产品业务需求列表 

### 请求URL
https://xxx.com/api.php/v2/products/:productID/epics
...
### 请求参数
|  名称  必填  描述
|  browseType  否  状态，默认是unclosed。(allstory 全部 | assignedtome 指派给我 | openedbyme 我创建 | reviewbyme 待我评审 | draftstory 草稿) 
    ...
    "epics": [
        {
            ...
            "fromVersion": "1",
            "openedBy": "admin",
            "openedDate": "2026-03-25 09:11:30",
            "assignedTo": "admin",
            "assignedDate": "2026-03-25 09:11:30",
            "approvedDate": "",
            "lastEditedBy": "admin",
            "lastEditedDate": "2026-03-25 09:11:31",
            "changedBy": "admin",
            "changedDate": "2026-03-25 09:11:31",
            "reviewedBy": "",
            "reviewedDate": "",
            "releasedDate": "",
            "closedBy": "",
