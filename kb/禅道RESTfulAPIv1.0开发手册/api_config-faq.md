...
####   2.1以获取1号产品的bug列表举例 
（1）保证账号有查看1号产品的bug访问权限（权限调整可以在后台-人员管理-权限中进行调整，具体可以参考文档 https://www.zentao.net/book/zentaopms/1010.html (https://www.zentao.net/book/zentaopms/1010.html)）
...
###  三、常见问题 
 3.1返回 error:not found获得的结果举例如下： 
