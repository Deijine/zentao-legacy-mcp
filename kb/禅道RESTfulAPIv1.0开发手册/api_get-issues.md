...
###  请求URL  https://xxx.com/api.php/v1/tickets 
...
|  browseType
 string
 否 工单状态（all 所有 | wait 待处理 | doing 处理中 | done 待关闭 | finishedbyme 由我解决 | openedbyme 由我创建 | assignedtome 指派给我）
|  param
 String
  否  模块ID， 默认为0
...
|    ∟ title
  int   是  标题
|    ∟ type
  string   是  工单类型(code 程序报错 | data 数据错误 | stuck 流程卡断 | security 安全问题 | affair 事务)
|    ∟ desc
  string  是 描述
|    ∟ openedBuild
  string  是 影响版本
